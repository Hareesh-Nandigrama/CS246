...
{
    public:
        int size;          //Total capacity of the page
        int r_capacity;    //Total available capacity
        vector <int> data; //Record data
        int count;         // count of records
        int index;
        page* next;        //next page pointer
        page* prev;        //previous page pointer
        page()
        {
            count = 0;
            next = nullptr;
